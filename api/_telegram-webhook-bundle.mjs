...
function getImportedExamSubjectKey(levelKey, catalogSubjectKey) {
  ...
  if (/^l[2-4]$/.test(levelKey)) return catalogSubjectKey;
...
function shariaExamsIntroText() {
  return [
    "\u{1F4DD} \u0627\u0644\u0623\u0631\u0634\u064A\u0641 \u0627\u0644\u062A\u0641\u0627\u0639\u0644\u064A \u0644\u0637\u0644\u0627\u0651\u0628 \u0627\u0644\u0634\u0631\u064A\u0639\u0629 \u0648\u0627\u0644\u0642\u0627\u0646\u0648\u0646",
...
function contentStatisticsText(stats) {
  ...
  return [
    ...
    "\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501",
    `\u{1F4E6} ${number(stats.libraryFileCount)} \u0645\u0644\u0641\u064B\u0627 \u0645\u062A\u0627\u062D\u064B\u0627`,
    `\u{1F5C2} ${number(stats.librarySectionsCount)} \u0623\u0642\u0633\u0627\u0645 \u0631\u0626\u064A\u0633\u064A\u0629`,
    ...libraryLines.length > 0 ? libraryLines : ["\u25AB\uFE0F \u064A\u062C\u0631\u064A \u062A\u062D\u062F\u064A\u062B \u062A\u0641\u0627\u0635\u064A\u0644 \u0627\u0644\u0645\u0643\u062A\u0628\u0629 \u062D\u0627\u0644\u064A\u064B\u0627."],
    "",
    `\u{1F552} \u0622\u062E\u0631 \u062A\u062D\u062F\u064A\u062B: ${stats.lastUpdatedAt.toLocaleString("ar-YE", { dateStyle: "medium", timeStyle: "short" })}`,
...
async function handleTelegramUpdate(update, store, sender, documentProvider = { download: downloadDriveDocument }, membershipChecker = { check: async () => "subscribed" }) {
  ...
  if (closedPoll?.id) {
    ...
    if (groupRound) {
      ...
      if (closedPoll.is_closed !== true && (groupStartedAt === void 0 || Date.now() - groupStartedAt < groupRound.timeLimitSeconds * 1e3)) return;
    ...
    if (closedPoll.is_closed !== true && elapsedMs < session.timeLimitSeconds * 1e3) return;
    const outcome = await store.resolveExamPoll({
      sessionId: session.id,
      telegramUserId: session.telegramUserId,
      questionIndex: session.questionIndex,
...
function cleanExamText(value) {
  return PDF_WATERMARK_PATTERNS.reduce((text2, pattern) => text2.replace(pattern, ""), value ?? "").replace(/[ \t]{2,}/g, " ").trim();
}
...
function registerTelegramWebhook(app2) {
  ...
  const setSubscriptionBridgeCors = (req, res) => {
    const origin = req.get("origin");
    if (origin && PLATFORM_ADMIN_ORIGINS.has(origin)) res.setHeader("Access-Control-Allow-Origin", origin);
    res.setHeader("Access-Control-Allow-Methods", "POST, OPTIONS");
  ...
  app2.options("/api/public/telegram/send-subscription", (req, res) => {
