...
describe("Telegram library conversation", () => {
  ...
  it("يعرض نماذج اصول الفقه المستوردة ويبدأ النموذج المحدد بالمدة المختارة", async () => {
    ...
    expect(annualUsulMenu).toContain("نموذج 2022م");
    expect(annualUsulMenu).toContain("نموذج 2023م");
    expect(annualUsulMenu).toContain("نموذج 2024 العام");
    expect(annualUsulMenu).toContain("نموذج 2024 الموازي");
    expect(annualUsulMenu).toContain("نموذج 2025 العام");
    expect(annualUsulMenu).toContain("نموذج 2025 الموازي");
    ...
    expect(messages.at(-1)?.text).toContain("اختر القسم التجريبي المطلوب");
    const usulTrainingMenu = JSON.stringify(messages.at(-1)?.replyMarkup);
    expect(usulTrainingMenu).toContain("رجوع إلى المواد");
  ...
  it("يعرض نماذج علم الاجرام والعقاب المستوردة ويبدأ النموذج السنوي", async () => {
    ...
    expect(annualCriminologyMenu).toContain("نموذج 2022م");
    expect(annualCriminologyMenu).toContain("نموذج 2023م");
    expect(annualCriminologyMenu).toContain("نموذج 2024 العام");
    expect(annualCriminologyMenu).toContain("نموذج 2024 الموازي");
    expect(annualCriminologyMenu).toContain("نموذج 2025 العام");
    expect(annualCriminologyMenu).toContain("نموذج 2025 الموازي");
    expect(annualCriminologyMenu).toContain("نموذج مختلط");
    ...
    expect(criminologyTrainingMenu).toContain("رجوع إلى المواد");
